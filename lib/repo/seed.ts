...
export const SEED_USERS: User[] = [
  { id: 'u01', name: 'Adit Pranatama', handle: '@aditpr', email: 'adit@animacompanion.com', role: 'staff', avatar: 'AP', joined: '2023-08', isActive: true },
  { id: 'u02', name: 'Salsa Aulia', handle: '@salsa.au', email: 'salsa@animacompanion.com', role: 'staff', avatar: 'SA', joined: '2023-04', isActive: true },
  { id: 'u03', name: 'Rina Mahardika', handle: '@rinamhd', email: 'rina@animacompanion.com', role: 'staff', avatar: 'RM', joined: '2024-01', isActive: true },
  { id: 'u04', name: 'Bagas Nugraha', handle: '@bagas.n', email: 'bagas@animacompanion.com', role: 'staff', avatar: 'BN', joined: '2022-11', isActive: true },
  { id: 'u05', name: 'Putri Larasati', handle: '@putrilrs', email: 'putri@animacompanion.com', role: 'staff', avatar: 'PL', joined: '2024-03', isActive: true },
  { id: 'u06', name: 'Reza Hidayat', handle: '@rezahd', email: 'reza@animacompanion.com', role: 'manager', avatar: 'RH', joined: '2022-02', isActive: true },
  { id: 'u07', name: 'Devi Andriani', handle: '@deviand', email: 'devi@animacompanion.com', role: 'admin', avatar: 'DA', joined: '2021-09', isActive: true },
];
