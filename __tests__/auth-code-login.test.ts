...
describe('Auth Code-Login API Route', () => {
  ...
  it('succeeds with a valid login code and sets cookie', async () => {
  ...
  it('fails with 403 user_inactive if user is inactive', async () => {
    const req = new Request('http://localhost:3300/api/v1/auth/code-login', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
